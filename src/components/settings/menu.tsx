...
const SettingsOverlay = (props: { open: boolean; onClose: () => void }) => {
	...
	return (
		...
		>
			<div className="sm:rounded-lg sm:w-1/2 sm:max-h-1/2-screen w-screen h-screen bg-slate-200 dark:bg-slate-900 fixed sm:top-1/4 sm:left-1/4 text-black dark:text-white">
